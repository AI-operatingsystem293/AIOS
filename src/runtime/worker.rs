...
use crate::runtime::message::{ExecutionResult, RuntimeMessage};
            ...
            loop {
                ...
                match message {
                    Ok(RuntimeMessage::Execute(job)) => {
                        println!("[Worker {}] Executing Task {}", self.id, job.task_id);
                        ...
                        let output = {
                            ...
                            registry.execute_command(&job.command, &job.input)
                        };
                        ...
                        let result = ExecutionResult {
                            ...
                            output: output.unwrap_or("Execution failed".to_string()),
                        };
